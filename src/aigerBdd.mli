...
(** Add to the aiger file, gates to compute the result of the 
    ...
    All the variables of the BDD should correspond to literals of the given aiger file, or be inside the given SymbolMap.
    otherwise a [UndeclaredLit] exception will be raised.
*)
val add_bdd_to_aiger : Aiger.t -> Aiger.lit SymbolMap.t -> Cudd.bdd -> (Aiger.t * Aiger.lit)
